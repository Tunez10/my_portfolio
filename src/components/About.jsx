...
export default function About() {
  ...
  return (
    <div id='about' className='scroll-mt-40 md:text-lg '>
   
      {/* // About me */}
      <div className=' md:p-10  p-7 lg:mx-64 mt-20 lg:flex gap-10 shadow-2xl' data-aos="fade-down" >
        {/* The left section */}
        <div className='lg:w-[50%] '>

          <div className='md:flex gap-10'>
            <div>
              <img className='h-[300px] w-[100%] rounded-xl shadow-xl' src={AboutImage} alt="" />
            </div>
